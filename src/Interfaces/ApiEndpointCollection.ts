...
import DraftShareInviteBankAPI from '../Api/DraftShareInviteBankAPI';
...
import NotificationFilterAPI from '../Api/NotificationFilterAPI';
...
export default interface ApiEndpointCollection {
    ...
    draftShareInviteBank: DraftShareInviteBankAPI;
    event: Event;
    ...
    noteText: NoteText;
    notificationFilter: NotificationFilterAPI;
    payment: Payment;
